...
try:
    prox= requests.get('https://github.com/BAYGID89/BAYGID-3/blob/main/BAYGID-1.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/BAYGID89/BAYGID-3/blob/main/BAYGID-1.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/BAYGID89/BAYGID-3/blob/main/BAYGID-1.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def aprv():
    ...
    if k in r:
        ...
        print("\033[1;92mYour Token is successfully Approved\33[1;37m")
                ...
                os.system("xdg-open https://wa.me/+8801323176125?text={k}")
                aprv()
                sys.exit()
...
logo=(""" \033[1;37m ##     ##   ########  ########  ########  
  ...
  \033[1;30m ##   ##    ##        ##        ##    ##   
   \033[1;32m ## ##     ##        ##        ##     ##  
    \033[1;34m ###      ########  ########  ##      ##   
\x1b[1;97m ---------------------------------------------
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   :  BAYGID
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  BAYGID
